...
import org.visicut.liblasercut.drivers.LaosCutterProperty;
...
public class LaosCutterTest extends LaosCutter{
  ...
  public void testVectorCode() throws UnsupportedEncodingException, IOException
  {
    ...
    this.setSupportsFrequency(true);
    this.setSupportsFocus(true);
    this.setSupportsPurge(true);
    this.setSupportsVentilation(true);
